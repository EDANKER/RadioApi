...
{
    public Settings(bool speak, bool settingsTime, bool settingsUser, bool turnItOnMusic, bool createPlayList, bool saveMusic, bool settingsScinaria, bool turnOnSector)
    {
        Speak = speak;
