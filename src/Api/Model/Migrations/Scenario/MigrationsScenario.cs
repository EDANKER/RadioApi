...
namespace Api.Model.Migrations.Scenario;

public class MigrationsScenario(int id, string name, string idMicroControllers, string time, string days, int idMusic)
{
