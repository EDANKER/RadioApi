...
public static class ConfigFile
{
    public static void Registration(IServiceCollection service, string redis)
    {
        ...
        service.AddSingleton<IJsonServices<DtoFloorMicroController>, JsonServices<DtoFloorMicroController>>();
        ...
        service.AddSingleton<IRepository<MicroController, DtoFloorMicroController, MicroController>, MicroControllerRepository>();
        service.AddSingleton<IScenarioServicesTime, ScenarioTimeServices>();
        service.AddSingleton<IRepository<Scenario, DtoPlayScenario, Scenario>, ScenarioTimeRepository>();
