...
public static class ConfigFile
{
    public static void Registration(IServiceCollection service, string redis)
    {
        ...
        service.AddSingleton<IJsonServices<Model.RequestModel.MicroController.MicroController>, JsonServices<Model.RequestModel.MicroController.MicroController>>();
        ...
        service.AddSingleton<IMicroControllerServices<Model.RequestModel.MicroController.MicroController, DtoMicroController>, MicroControllerServices>();
        service.AddSingleton<IRepository<Model.RequestModel.MicroController.MicroController, DtoMicroController, Model.RequestModel.MicroController.MicroController>, MicroControllerFloorRepository>();
